...
public class ExceptionAdvice{
    ...
    public ResponseEntity<Object> handleBindExceptions(BindException exception, WebRequest request){
        String errors =
                exception.getAllErrors().stream().map(ObjectError::getDefaultMessage)
                         .filter(err -> err != null && !err.isBlank())
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        return handleException(exception, message, ErrorType.REQUEST_VALIDATION_FAILED,
                BAD_REQUEST);
    }
